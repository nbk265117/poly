#!/usr/bin/env python3
"""
BOT ETH - Trading Polymarket dédié Ethereum
...
# CONFIG ETH OPTIMISÉE (backtest 2025: 55.4% WR)
SYMBOL = 'ETH/USDT'
BASE = 'ETH'
CONFIG = {
    'rsi_period': 7,
...
MAX_PRICE = 0.525  # 52.5¢ plus réaliste
...
def main():
    ...
    bot = BotETH(shares=args.shares, is_live=args.live)
    bot.run()
